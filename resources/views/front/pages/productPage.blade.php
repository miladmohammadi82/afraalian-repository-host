                    ...
                    <div class="servisess-product-page">
                        <div class="help-syntax-order">
                            ...
                            <div class="box-dropdown-help-order">
                                <p>
                                    جهت ثبت سفارش، تعداد عسل را مشخص کنید و بعد روی دکمه افزودن به سبد خرید کلیک کنید و درمرحله بعد اگر ثبت نام نکردید باید ثبت نام کنید و در مرحله بعدی باید آدرس و اطلاعات پستی را وارد کنید  و در آخر میتونیدبا کلیک بر روی دکمه ادامه فرایند خرید سفارشتون رو ثبت کنید
                                </p>
                            </div>
                        </div>
                    </div>
